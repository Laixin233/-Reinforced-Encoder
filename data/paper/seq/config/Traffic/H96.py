...
class Traffic_data(TaskDataset):
    def __init__(self, opts):
        super().__init__(opts)
        
    def info_config(self):
        self.info.normal = False
        self.info.data_path = 'data/paper/seq/real/traffic/'
        
        # self.info.series_name = ['ETTh1','ETTh2']  
        
        self.info.series_name = ['traffic']
...
class seq2seq_base(nn_base):
    ...
    def hyper_init(self,):
        ...
        self.hyper.component = 'RNN' #['RNN','MGU','GRU','LSTM', 'IndRNN', 'PeepholeLSTM','PhaseLSTM','xLSTM']
        self.hyper.optimizer = 'adam'#RMSprop：xlstm,adam:peepholeLSTM
        # tune
        self.hyper.encoder_hidden_size = 30 # xlstm：65;rnn,IndRNN，phasedlstm:30
...
class RNNPPO(seq2seq_base):
    ...
    def hyper_modify(self):  
        ...
        self.hyper.buffer_capacity = 1000
