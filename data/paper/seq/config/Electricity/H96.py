...
class Electricity_data(TaskDataset):
    def __init__(self, opts):
        super().__init__(opts)
        
    def info_config(self):
        self.info.normal = False
        self.info.data_path = 'data/paper/seq/real/electricity/'
        
        
        self.info.series_name = ['electricity']
    ...
    def sub_config(self,):
        ...
        for i in range(self.info.num_series):
            ...
            if self.info.num_variate == 1:
                ...
                raw_ts = df.values[:,1:]#去掉时间 _start, self.info.num_variate+1
...
class seq2seq_base(nn_base):
    ...
    def hyper_init(self,):
        ...
        self.hyper.component = 'GRU' #['RNN','MGU','GRU','LSTM', 'IndRNN', 'PeepholeLSTM','PhaseLSTM','xLSTM']
        self.hyper.optimizer = 'adam'#rmsprop:xlstm,adam:peepholeLSTM
        # tune
        self.hyper.encoder_hidden_size = 80 # 65:xlstm; 30:rnn,IndRNN，phasedlstm； 120：MGU
        self.hyper.encoder_num_layer = 3 # 2 # xlstm：2

        self.hyper.learning_rate = 0.01 # xlstm：0.05 
        self.hyper.step_gamma = 0.91 # xlstm：0.91 GRU:0.82 
        
        
        self.hyper.agent_hidden_size = 256 #256
...
class RNNPPO(seq2seq_base):
    ...
    def base_modify(self):
        ...
        self.model='PPO4Pred.py' #PPO_patch,PPO_ER,PPO4Pred
    ...
    def hyper_modify(self):  
        ...
        # env
        # self.hyper.encoder_hidden_size = 100 # 65:xlstm; 30:rnn IndRNN，phasedlstm:120 , MGU GRU:120 LSTM：120 
        # self.hyper.encoder_num_layer = 2 # 2 # xlstm：2

        # self.hyper.learning_rate = 0.001 # xlstm：0.05, RNN：0.001, MGU：0.005, GRU：0.01, LSTM:0.008, phasedlstm：0.006
        ...
        self.hyper.ppo_epochs = 10
        self.hyper.buffer_capacity = 10000
