...
class pm_data(TaskDataset):
    ...
    def info_config(self):
        ...
        self.info.data_path = 'data/paper/seq/pm2.5'
        # self.info.series_name = ['Beijing', 'Chengdu', 'Guangzhou','Shanghai','Shenyang']
        self.info.series_name = ['Guangzhou']
        self.info_yids = [2015]
        self.info.num_series = len(self.info.series_name) 
        self.info.steps = 24*3
        self.info.cov_dim = 0
        self.info.period = 24*2
    ...
    def sub_config(self,):
        ...
        for i in range(self.info.num_series):
            ...
            for yid in self.info_yids:
                df = pd.read_csv(os.path.join(self.info.data_path, '{}'.format(yid),'{}.post.csv'.format(_name)))
                data = df['PM_US Post']
...
class seq2seq_base(nn_base):
    ...
    def hyper_init(self,):
        ...
        # tune H = 24
        self.hyper.encoder_hidden_size = 120
        self.hyper.encoder_num_layer = 1
        self.hyper.decoder_hidden_size = 140
        ...
        # self.hyper.encoder_num_layer = 1
        # self.hyper.decoder_hidden_size = 110
        # self.hyper.decoder_num_layer = 2
        # self.hyper.decoder_input_size = 80
        # self.hyper.learning_rate = 0.005
        # self.hyper.step_gamma = 0.92
...
class seq2seqRLPreT(seq2seq_base):
    def __init__(self):
        super().__init__()
    ...
    def hyper_modify(self):
        ...
        self.hyper.epochs = 100    # v1 = 30
        self.hyper.base_iter = 10
        self.hyper.preTrain_epochs = 10   # v1 = 10
        # tune H = 48
        self.hyper.agent_hidden_size = 224
...
class mlp(nn_base):
    ...
    def hyper_init(self):
        ...
        # self.hyper.step_gamma = 0.51
        
        
        # tune H = 72
        self.hyper.hidden_size = 150
        self.hyper.learning_rate = 0.003722539834873121
