...
class msvr(nn_base):
    ...
    def hyper_init(self):
        ...
        # tune
        self.hyper.C= 0.19512934226359632
        self.hyper.epsilon=0.046415888336127774
        self.hyper.gamma= 0.2
