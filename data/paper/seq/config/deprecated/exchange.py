...
class exchange_data(TaskDataset):
    ...
    def sub_config(self,):
        ...
        for i in range(self.info.num_series):
            df = pd.read_excel('data/paper/seq/exchange/exchange_aus.xlsx',index_col=None,header=0)
            raw_ts = df['Australia'].values
...
class seq2seq_base(nn_base):
    ...
    def hyper_init(self,):
        ...
        # H = 84
        # self.hyper.encoder_hidden_size = 50
        # self.hyper.encoder_num_layer = 1
...
class mlp(nn_base):
    ...
    def hyper_init(self):
        ...
        self.hyper.learning_rate = 0.0001
        self.hyper.step_lr = 20
        self.hyper.step_gamma = 0.9
