...
class energy_data(TaskDataset):
    ...
    def info_config(self):
        ...
        self.info.data_path = 'data/paper/seq/energy/energydata.xlsx'
        # 选取2016/3/1 0：00 ~ 2016/5/27 18：00, values[-12637:]
        # self.info.series_name = ['Appliances','light']
        self.info.series_name = ['Appliances']
        self.info.num_series = len(self.info.series_name) 
        self.info.steps = 6*24*7
        self.info.cov_dim = 0
        self.info.period = 24
...
class seq2seq_base(nn_base):
    ...
    def hyper_init(self,):
        ...
        # tune H = 24
        self.hyper.encoder_hidden_size = 90
...
class seq2seqRL(seq2seq_base):
    ...
    def hyper_modify(self):
        ...
        self.hyper.mlp_lr  = 0.0005
        self.hyper.mlp_stepLr  = 40
        self.hyper.mlp_gamma = 0.87
...
class msvr(nn_base):
    ...
    def hyper_init(self):
        ...
        # tune H = 96
        self.hyper.C= 0.02438354098268829
        self.hyper.epsilon=0.002154434690031882
...
class mlp(nn_base):
    ...
    def hyper_init(self):
        ...
        self.hyper.learning_rate = 0.1
        self.hyper.step_lr = 40
        self.hyper.step_gamma = 0.74
