...
class xLSTM(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_layers, num_blocks,
        ...
        #     xLSTMBlock(self.input_size, hidden_size, num_layers, dropout, lstm_type)
        #     for _ in range(num_blocks)
        # ])
        self.layer = xLSTMBlock(self.input_size, hidden_size, num_layers, dropout, lstm_type)
    ...
    def forward(self, input_seq, hidden_states=None):
        ...
        output_seq,hidden_states = self.layer(input_seq, hidden_states)
